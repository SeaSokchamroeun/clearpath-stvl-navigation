...
def generate_launch_description():
    ...
    node_cmd_vel_bridge = Node(
        ...
        arguments=
            [
                'a200_1103/cmd_vel@geometry_msgs/msg/Twist[ignition.msgs.Twist'
                ,
                '/model/a200_1103/robot/cmd_vel@geometry_msgs/msg/Twist]ignition.msgs.Twist'
                ,
            ]
        ,
        remappings=
    ...
    node_odom_base_tf_bridge = Node(
        ...
        arguments=
            [
                '/model/a200_1103/robot/tf@tf2_msgs/msg/TFMessage[ignition.msgs.Pose_V'
                ,
            ]
        ,
        remappings=
